...
rack_info = {
    "bzAi1DPflIKzg75ipRF3": {"name": "David Graz Teszt HA controller", "tzadd": 1, "keys": ["ps_controller_handler", "ps_firebase_main", "ps_firebaseremoteadmin", "ps_smartbox", "memory_available_rate", "sda2_usage"]},
    "LCFEL7NLIqFX4Cw6GQit": {"name": "Locker Astoria (Controller)", "tzadd": 2, "keys": ["ps_controller_handler", "ps_firebase_main", "ps_smartbox", "ps_firebaseremoteadmin", "memory_available_rate", "sda2_usage"]},
