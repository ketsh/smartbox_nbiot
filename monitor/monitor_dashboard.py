...
rack_info = {
    ...
    "L3L2BQwvrjMJfTcEdADW": {"name": "Gödöllői Városi Könyvtár", "tzadd": 2, "keys": ["ps_controller_handler", "ps_firebase_main", "ps_firebaseremoteadmin", "ps_smartbox", "pid_firefox_running", "memory_available_rate", "sda2_usage"]}
}
